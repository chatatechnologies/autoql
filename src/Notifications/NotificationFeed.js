...
export function NotificationFeed(selector, options) {
    ...
    emptyStateContainer.appendChild(
        htmlToElement(`
    ...
    container.addEventListener('scroll', () => {
        if (container.scrollTop + container.offsetHeight + 60 > container.scrollHeight && !wrapper.isLoading) {
    ...
    wrapper.toggleAll = () => {
        var elItems = container.querySelectorAll('.chata-notification-list-item');
