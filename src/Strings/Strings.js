...
export const strings = new LocalizedStrings({
    ...
    es: {
        ...
        dataExplorerMessage2:
            'Simplemente haga clic en cualquiera de las opciones devueltas para ejecutar la consulta en Data Messenger.',
        ...
        sampleQueriesNotFound:
            'Lo siento, no pude encontrar ninguna consulta que coincida con su entrada. Intente ingresar un tema o palabra clave diferente en su lugar.',
