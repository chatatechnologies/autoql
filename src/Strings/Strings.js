...
export const strings = new LocalizedStrings({
    ...
    es: {
		...
		downloadedCSVWarning: 'ADVERTENCIA: El archivo que ha solicitado es más grande que',
		partialCSVDataWarning: 'Esto excede el tamaño máximo de descarga y solo recibirá datos parciales.',
