...
function ChatBarEvent(event){
    ...
    // event.target.parentElement.appendChild(responseLoadingContainer);

    suggestionList.style.display = 'none';
    if(event.target.value){
        ChatDrawer.autocomplete(event.target.value, suggestionList);
    }
}
(function(document, window, ChatDrawer, undefined) {
    ...
    ChatDrawer.getChatBar = function(){
        ...
        <div class="chata-bar-container chat-drawer-chat-bar autosuggest-top">
            <div class="chat-bar-text">
                ...
                <input type="text" autocomplete="off" aria-autocomplete="list" class="chata-input chat-bar left-padding" placeholder="Ask me anything" value="" id="" onkeyup="ChatBarEvent(event)">
