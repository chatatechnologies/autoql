...
(function(document, window, ChatDrawer, undefined) {
                    ...
                    ChatDrawer.ajaxCall(URL, function(jsonResponse){
                        ...
                        switch(jsonResponse['display_type']){
                            ...
                            case 'line':
                                ...
                                ChatDrawer.createLineChart(responseRenderer, grouped, col1, col2, hasNegativeValues, false, 'data-chartrenderer');
                            break;
                            case 'bar':
                                var values = ChatDrawer.formatDataToBarChart(jsonResponse);
                                var grouped = values[0];
                                ...
                                var col1 = ChatDrawer.formatColumnName(jsonResponse['columns'][0]['name']);
                                var col2 = ChatDrawer.formatColumnName(jsonResponse['columns'][1]['name']);
                                ChatDrawer.createBarChart(responseRenderer, grouped, col1, col2, hasNegativeValues, false, 'data-chartrenderer');
                            break;
                            case 'column':
                                var values = ChatDrawer.formatDataToBarChart(jsonResponse);
                                var grouped = values[0];
                                ...
                                var col2 = ChatDrawer.formatColumnName(jsonResponse['columns'][1]['name']);
                                var hasNegativeValues = values[1];
                                ChatDrawer.createColumnChart(responseRenderer, grouped, col1, col2, hasNegativeValues, false, 'data-chartrenderer');
                            break;
                            case 'heatmap':
                                ...
                                ChatDrawer.createHeatmap(responseRenderer, labelsX, labelsY, values, col1, col2, col3, false, 'data-chartrenderer');
                            break;
                            case 'bubble':
                                var values = ChatDrawer.formatDataToHeatmap(jsonResponse);
                                var labelsX = ChatDrawer.getUniqueValues(values, row => row.labelX);
                                ...
                                var col2 = ChatDrawer.formatColumnName(jsonResponse['columns'][1]['name']);
                                var col3 = ChatDrawer.formatColumnName(jsonResponse['columns'][2]['name']);
                                ChatDrawer.createBubbleChart(responseRenderer, labelsX, labelsY, values, col1, col2, col3, false, 'data-chartrenderer');
                            break;
                            case 'help':
    ...
    ChatDrawer.createBubbleChart = function(component, labelsX, labelsY, data, col1, col2, col3, fromChatDrawer=true, valueClass='data-chartindex'){
    ...
    ChatDrawer.createHeatmap = function(component, labelsX, labelsY, data, col1, col2, col3, fromChatDrawer=true, valueClass='data-chartindex'){
        var margin = {top: 5, right: 10, bottom: 50, left: 130},
        width = component.parentElement.clientWidth - margin.left;
        var height;
        if(fromChatDrawer){
    ...
    ChatDrawer.createLineChart = function(component, data, col1, col2, hasNegativeValues, fromChatDrawer=true, valueClass='data-chartindex'){
    ...
    ChatDrawer.createColumnChart = function(component, data, col1, col2, hasNegativeValues, fromChatDrawer=true, valueClass='data-chartindex'){
        var margin = {top: 5, right: 10, bottom: 50, left: 90},
        width = component.parentElement.clientWidth - margin.left;
        var height;
        if(fromChatDrawer){
    ...
    ChatDrawer.createBarChart = function(component, data, col1, col2, hasNegativeValues, fromChatDrawer=true, valueClass='data-chartindex'){
